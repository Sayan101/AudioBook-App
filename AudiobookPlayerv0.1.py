...
playPhoto = PhotoImage(file='C:\\Users\\Sayan\\github\\AudioBook-App\\play.png')
play=Button(root,text='play!',image=playPhoto,bd='5',command=lambda: listenToEbook())
pausePhoto = PhotoImage(file='C:\\Users\\Sayan\\github\\AudioBook-App\\pause.png')
pause=Button(root,text='pause!',image=pausePhoto,bd='5',command=lambda: pauseEbook())
stopPhoto = PhotoImage(file='C:\\Users\\Sayan\\github\\AudioBook-App\\stop.png')
stop=Button(root,text='stop!',image=stopPhoto,bd='5',command=lambda: stopEbook())
